...
namespace HotelBookingBlazors_WebAPP.Migrations
{
    ...
    [Migration("20240711054921_AddEntities")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotelBookingBlazors_WebAPP.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("HotelBookingBlazor.Data.Entities.Booking", b =>
                {
                    b.HasOne("HotelBookingBlazors_WebAPP.Data.ApplicationUser", "Guest")
                        .WithMany()
            ...
            modelBuilder.Entity("HotelBookingBlazor.Data.Entities.RoomType", b =>
                {
                    b.HasOne("HotelBookingBlazors_WebAPP.Data.ApplicationUser", "AddedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("HotelBookingBlazor.Data.Entities.RoomTypeAmenity", b =>
                {
                    ...
                    b.HasOne("HotelBookingBlazor.Data.Entities.RoomType", null)
                        .WithMany("Amenities")
                        .HasForeignKey("RoomTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HotelBookingBlazor.Data.Entities.Room", "RoomType")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("HotelBookingBlazors_WebAPP.Data.ApplicationUser", null)
                        .WithMany()
